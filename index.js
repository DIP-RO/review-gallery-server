...
async function  run (){
  try{
        const serviceAll = client.db('ServiceGuru').collection('services');
        const reviewAll = client.db('ServiceGuru').collection('review');
...
const addReview = req.body;
  ...
  const result = await serviceAll.insertOne(addReview);
